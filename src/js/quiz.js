document.addEventListener("DOMContentLoaded", () => {
  ...
  const questoes = [
    "O que é uma enchente? Quando chove demais e a água cobre as ruas ou quando o sol aparece depois da chuva?",
    "Qual é uma das principais causas das enchentes nas cidades? Plantio de árvores ou a pavimentação excessiva e entupimento de bueiros",
  ...
  function mostrarResultado() {
    ...
    questoes.forEach((questoes, index, opcoes) => {
